import { c as createToaster, j as jsxRuntimeExports, P as Portal, T as Toaster$1, a as ToastRoot, S as Spinner, b as ToastIndicator, d as Stack, e as ToastTitle, f as ToastDescription, g as ToastActionTrigger, h as ToastCloseTrigger, i as createContext, u as useContextSelector, r as reactExports, l as lookup, k as reactDomExports, m as TooltipRoot, n as TooltipTrigger, o as TooltipPositioner, p as TooltipContent, q as TooltipArrow, s as TooltipArrowTip, I as IconButton, C as ClientOnly, t as Skeleton, z, F as FaSun, v as FaMoon, J, B as Button$1, A as AbsoluteCenter, w as Span, L as LuX, x as PopoverPositioner, y as PopoverContent$1, D as PopoverArrow$1, E as PopoverArrowTip, G as PopoverCloseTrigger, H as PopoverRoot$1, K as PopoverTrigger$1, M as PopoverBody$1, N as PopoverTitle$1, O as HStack, Q as Flex, R as Heading, U as MdHealthAndSafety, V as MdSpeed, W as TbGitBranch, X as Separator, Y as MdUpdate, Z as IoMdAdd, _ as LuFileCog, $ as MdBrowserUpdated, a0 as LiaToiletSolid, a1 as IoReload, a2 as CheckboxRoot, a3 as CheckboxHiddenInput, a4 as CheckboxControl, a5 as CheckboxIndicator, a6 as CheckboxLabel, a7 as DialogBackdrop$1, a8 as DialogPositioner, a9 as DialogContent$1, aa as DialogCloseTrigger$1, ab as DialogRoot$1, ac as DialogHeader$1, ad as DialogTitle$1, ae as DialogBody$1, af as DialogFooter$1, ag as DialogActionTrigger$1, ah as TbAsterisk, ai as TbLetterZ, aj as TbLetterY, ak as TbLetterX, al as TbLetterW, am as TbLetterV, an as TbLetterU, ao as TbLetterT, ap as TbLetterS, aq as TbLetterR, ar as TbLetterQ, as as TbLetterP, at as TbLetterO, au as TbLetterN, av as TbLetterM, aw as TbLetterL, ax as TbLetterK, ay as TbLetterJ, az as TbLetterI, aA as TbLetterH, aB as TbLetterG, aC as TbLetterF, aD as TbLetterE, aE as TbLetterD, aF as TbLetterC, aG as TbLetterB, aH as TbLetterA, aI as Input, aJ as keyframes, aK as chroma, aL as Text, aM as TableRow, aN as TableCell, aO as FaFolderOpen, aP as MdAutoFixHigh, aQ as ActionBarPositioner, aR as ActionBarContent$1, aS as ActionBarCloseTrigger, aT as ActionBarRoot$1, aU as ActionBarSelectionTrigger$1, aV as ActionBarSeparator$1, aW as Kbd, aX as IoMdClose, aY as Group, aZ as InputElement, a_ as React, a$ as FaChevronDown, b0 as FaChevronRight, b1 as Box, b2 as TableRoot, b3 as TableColumnGroup, b4 as TableColumn, b5 as TableHeader, b6 as TableColumnHeader, b7 as TableBody, b8 as VscDiffSingle, b9 as SiSubversion, ba as LuSearch, bb as AccordionItemTrigger$1, bc as AccordionItemIndicator, bd as AccordionItemContent$1, be as AccordionItemBody, bf as AccordionRoot$1, bg as AccordionItem$1, bh as FieldRoot, bi as FieldLabel, bj as FieldRequiredIndicator, bk as FieldHelperText, bl as FieldErrorText, bm as NumberInputRoot$1, bn as NumberInputControl, bo as NumberInputIncrementTrigger, bp as NumberInputDecrementTrigger, bq as NumberInputInput, br as chakra, bs as index, bt as FaTrello, bu as MdKeyboardReturn, bv as TableScrollArea, bw as Link, bx as LuExternalLink, by as TableFooter, bz as FaChevronUp, bA as Code, bB as MdError, bC as BiMessageDetail, bD as IoWarning, bE as FiHelpCircle, bF as FiEdit, bG as HiOutlineInformationCircle, bH as ProgressTrack, bI as ProgressRange, bJ as ProgressLabel$1, bK as ProgressRoot$1, bL as ProgressValueText$1, bM as LuCheck, bN as LuClipboard, bO as ListRoot, bP as ListItem, bQ as ListIndicator, bR as FaCircleCheck, bS as CheckboxGroup, bT as FaCheck, bU as CollapsibleRoot, bV as CollapsibleContent, bW as Image, bX as VscChromeMinimize, bY as FaRegSquare, bZ as ChakraProvider, b_ as defaultSystem, b$ as clientExports } from "./vendor.js";
...
function Header() {
  ...
  const handleOpenHealthMonitor = reactExports.useCallback(() => {
    window.open("http://localhost:4000/health");
  }, []);
  const handleOpenPerformanceMonitor = reactExports.useCallback(() => {
    window.open("http://localhost:4000/performance");
  }, []);
  const handleOpenSVNDashboard = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { wrap: "wrap", my: 5, gapY: 5, justify: "space-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { align: "flex-start", alignItems: "center", columnGap: 2, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { spacing: 1, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonIconTooltip, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MdHealthAndSafety, {}), onClick: handleOpenHealthMonitor, colorPalette: "yellow", variant: "subtle", label: "Health Monitor", placement: "bottom-end", size: "md" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonIconTooltip, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MdSpeed, {}), onClick: handleOpenPerformanceMonitor, colorPalette: "yellow", variant: "subtle", label: "Performance Dashboard", placement: "bottom-end", size: "md" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonIconTooltip, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(TbGitBranch, {}), onClick: handleOpenSVNDashboard, colorPalette: "yellow", variant: "subtle", label: "SVN Dashboard", placement: "bottom-end", size: "md" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { orientation: "vertical", height: "24px" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(HStack, { spacing: 1, children: [
