...
export function initialiseServer() {
	...
	logger.info("3) Load any disk-based state on startup (if present) ✅");
	//-------------------------------------------------------------------
	// 4) Middleware, Static Serving, Setup
	//-------------------------------------------------------------------
	...
	logger.info("4) Middleware, Static Serving, Setup ✅");
	//-------------------------------------------------------------------
	// 5) Utility functions (logging, SVN, file ops, etc.)
	//-------------------------------------------------------------------
	...
	logger.info("5) Utility functions (logging, SVN, file ops, etc.) ✅");
	//-------------------------------------------------------------------
	// 6) Trello helpers
	//-------------------------------------------------------------------
	/**
	...
	logger.info("6) Trello helpers ✅");
	//-------------------------------------------------------------------
	// 7) SVN logic (queues, commands, watchers)
	//-------------------------------------------------------------------
	...
	logger.info("8) Socket.IO Handlers ✅");
	//-------------------------------------------------------------------
	...
	logger.info("9) Socket.IO connection logic ✅");
	//-------------------------------------------------------------------
	// 10) Catch-all route for your React app
	//-------------------------------------------------------------------
	app.get("*", (req, res) => {
	...
	logger.info("10) Catch-all route for your React app ✅");
	//-------------------------------------------------------------------
	// 11) Graceful shutdown for signals (optional)
	//-------------------------------------------------------------------
	...
	logger.info("11) Graceful shutdown for signals (optional) ✅");
	//-------------------------------------------------------------------
	// 12) Finally, start listening
	//-------------------------------------------------------------------
	...
	logger.info("12) Finally, start listening ✅");
