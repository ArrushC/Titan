...
export const ActionBarContent = React.forwardRef(function ActionBarContent(props, ref) {
...
export const ActionBarCloseTrigger = React.forwardRef(function ActionBarCloseTrigger(props, ref) {
	return (
