...
export const ClipboardLabel = React.forwardRef(function ClipboardLabel(props, ref) {
...
export const ClipboardIconButton = React.forwardRef(function ClipboardIconButton(props, ref) {
	return (
		<ChakraClipboard.Trigger asChild>
...
export const ClipboardInput = React.forwardRef(function ClipboardInputElement(props, ref) {
	return (
