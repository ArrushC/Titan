	...
	return (
		<ChakraSwitch.Root ref={rootRef} {...rest}>
			...
			<ChakraSwitch.Control>
				<ChakraSwitch.Thumb>{thumbLabel && <ChakraSwitch.ThumbIndicator fallback={_optionalChain([thumbLabel, "optionalAccess", (_) => _.off])}>{_optionalChain([thumbLabel, "optionalAccess", (_2) => _2.on])}</ChakraSwitch.ThumbIndicator>}</ChakraSwitch.Thumb>
